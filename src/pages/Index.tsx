    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <nav className="border-b border-border px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center gap-4">
          ...
          <a href="https://github.com/adjmx/smpl.fizx.uk" target="_blank" rel="noopener noreferrer" title="Source on GitHub" aria-label="Source on GitHub" className="shrink-0 text-muted-foreground/60 hover:text-primary transition-colors">
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-6 py-10 space-y-10">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between gap-3">
            <AnimatedTitle accent="smpl" rest="²" from="#2dd4bf" to="#34d399" suffixRgba="rgba(52,211,153,0.55)" />
            <NstartHand />
          </div>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <p className="text-sm text-muted-foreground">Share short audio samples on Nostr — publish a URL, play, download, collaborate.</p>
